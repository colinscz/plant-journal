...
/**
  ...
  *
  * @checksum - 5e2f2c8dcd344cf0a6306830da56c351411499fa5415081475a34d59c2d4892b
  * @variables - radius=rounded,accentColor=emerald,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
